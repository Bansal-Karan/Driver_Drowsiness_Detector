          ...
          <div className="relative">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full pl-9 pr-4 py-2.5 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white"
              />
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                minLength="6"
                className="w-full pl-9 pr-10 py-2.5 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white"
              />
              <button
                type="button"
